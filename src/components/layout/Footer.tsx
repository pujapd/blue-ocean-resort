    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-xl font-bold mb-4">Blue Ocean Resort</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/rooms" className="text-gray-400 hover:text-white transition">
                  Rooms & Suites
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex items-start space-x-2">
                ...
                <span>Cox's Bazar Beach, Bangladesh</span>
              </li>
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>info@blueoceanresort.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; 2026 Blue Ocean Resort. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
